...
<div class="btn-group" role="group" aria-label="Basic example">
	<a class="btn btn-primary" href="day16-insert.php">Insert</a>
	<a class="btn btn-warning" href="#">#</a>
</div>
	<a class="btn btn-danger position-absolute top-0 end-0" href="logout.php">LOGOUT</a>
...
while ($row=$result->fetch_assoc()) {
	...
	<td><a href='day16-update.php?id=".$row['fld_pid']."'>UPDATE</a></td>
	<td><a href='day16-delete.php?id=".$row['fld_pid']."'>DELETE</a></td></td>
	</tr>";
}
?>
</table>
